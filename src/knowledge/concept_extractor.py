...
class ConceptExtractor:
    ...
    def extract_concepts_from_text(self, text: str, 
        ...
        """
        Extract concepts from a block of text.
        ...
        self.logger.debug(f"Extracted {len(unique_concepts)} unique concepts from text")
    ...
    def extract_relationships_from_text(self, text: str,
        ...
        concept_names = {concept.name.lower(): concept.name for concept in extracted_concepts}
    ...
    def process_document_page(self, page_text: str,
                            document_name: str,
                            page_number: int) -> Tuple[List[ExtractedConcept], List[ExtractedRelationship]]:
        """
        ...
        concepts = self.extract_concepts_from_text(page_text, document_name, page_number)
